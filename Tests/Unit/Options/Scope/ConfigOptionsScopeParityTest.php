...
final class ConfigOptionsScopeParityTest extends PluginLibTestCase {
	...
	public function test_site_scope_default_parity(): void {
		...
		$optsViaFactory = RegisterOptions::from_config($cfg, StorageContext::forSite());
	...
	public function test_network_scope_parity(): void {
		...
		$optsViaFactory = RegisterOptions::from_config($cfg, StorageContext::forNetwork());
	...
	public function test_blog_scope_with_entity_parity(): void {
		...
		$optsViaFactory = RegisterOptions::from_config($cfg, StorageContext::forBlog(123));
	...
	public function test_user_scope_with_entity_parity(): void {
		...
		$optsViaFactory = RegisterOptions::from_config($cfg, StorageContext::forUser(5, 'option', true));
