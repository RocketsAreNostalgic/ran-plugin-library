<?php
/**
 * Action Hooks Manager for WordPress plugins.
 *
 * This file contains the ActionHooksManager class which manages objects that implement
 * the ActionHooksInterface for registering WordPress action hooks.
 *
...
class ActionHooksManager implements AccessoryBaseInterface {
	 ...
	 *
	 * @param ActionHooksInterface $object An object that implements the ActionHooksInterface.
	 */
	 ...
	 */
	private function register_action( ActionHooksInterface $object, string $name, mixed $parameters ): void {
	 ...
	 * @param ActionHooksInterface $object Any object the implements the ActionHookAssetInterface.
	 */
	private function register_actions( ActionHooksInterface $object ): void {
