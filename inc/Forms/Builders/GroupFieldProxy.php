<?php
/**
 * GroupFieldProxy: Field proxy that returns GroupBuilder from end_field().
 *
 * Provides correct IDE type hints when fields are added within a GroupBuilder context.
 *
...
class GroupFieldProxy extends ComponentBuilderProxy {
	/**
	 * @var GroupBuilder
	 */
	protected GroupBuilder $groupParent;

	/**
	 * @param ComponentBuilderBase $builder The component builder.
	 * @param GroupBuilder $parent The parent GroupBuilder.
	...
	/**
	 * End field configuration and return to the GroupBuilder.
	 *
	 * @return GroupBuilder The parent GroupBuilder for continued chaining.
	 */
	public function end_field(): GroupBuilder {
