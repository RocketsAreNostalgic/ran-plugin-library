 ...
 *
 * @extends SectionBuilderBase<AdminSettingsPageBuilder>
 */
class AdminSettingsSectionBuilder extends SectionBuilderBase {
	/**
	 * @param AdminSettingsPageBuilder $pageBuilder The parent page builder.
