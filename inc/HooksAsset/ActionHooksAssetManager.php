...
use Ran\PluginLib\AssetsAPI\AssetManagerBaseInterface;
use Ran\PluginLib\HooksAsset\ActionHooksInterface;
 ...
 */
class ActionHooksAssetManager implements AssetManagerBaseInterface {
	/**
